    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Draw Participants</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('home/index')?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Draw Participants</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card card-table">
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title"><?php echo $participants[0]['title']?> Draw Participants</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0  table-striped" id="example">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($participants as $key) { ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
